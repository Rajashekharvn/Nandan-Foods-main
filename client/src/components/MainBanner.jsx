...
const MainBanner = () => {
  return (
    <div className="relative min-h-[300px] bg-gray-100 b-g-cover bg-center rounded-xl overflow-hidden">
      <img
      ...
      />
      <div className="absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center pb-8 md:pb-0 px-4 md:pl-18 lg:pl-24">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center md:text-left max-w-72 md:max-w-80 lg:max-w-105 leading-tight lg:leading-15">
          Authentic flavors of Uttar Karnataka, made in traditional way.
        </h1>
